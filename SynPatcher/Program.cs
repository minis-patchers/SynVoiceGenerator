...
public static class Program
{
    ...
    static string CleanString(this string str) => new string([.. REG.HiddenFN2.Replace(REG.HiddenFN.Replace(str, ""), "").Where(IsValidChar)]).Trim().TrimEnd('.').TrimEnd('!').TrimEnd(',').TrimEnd('?').Replace("\n", " ").Replace("\r", " ").Replace("\t", " ").Replace("  ", " ").TrimEnd(' ');
    static string RemovePunct(this string str) => str.Replace(".", "").Replace("!", "").Replace("?", "");
